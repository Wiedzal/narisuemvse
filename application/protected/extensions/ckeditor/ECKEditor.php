...
class ECKEditor extends CInputWidget {
    ...
    public function  __construct($owner=null) {
		...
		$_SESSION['KCFINDER']['uploadURL'] = Yii::app()->baseUrl."/ckfinder/"; // URL for the uploads folder
		$_SESSION['KCFINDER']['uploadDir'] = $_SERVER['DOCUMENT_ROOT']."/ckfinder/"; // path to the uploads folder
